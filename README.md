JmfWeather
Práctia asignatura Android Fundamiental, Master Programación de Apps, U-Tad.

La práctia consiste en realizar una aplicación de meteorología con los siguientes requisitos:
...
3. Uso de estilos y temas.
    ...
    La aplicación utiliza difrentes estilos y temas para móviles y tablets.
...
4. Uso de navegación efectiva (lateral y ancestral especialmente)
    ...
    La actividad CCityListActivity cotiene un drawer con una pequeña ayuda.

5. Carga y parseo de datos mediante llamadas HTTP, en background.

    El servicio CWeatherRetrieverService se encarga de actualizar periodicamente la información de las ciudades en la BB.DD.
...
7. Almacenamiento persistente de la información, a modo de caché, en base de datos SQLite.
    ...
    La Aplicación utiliza SQlite para almacenar la información de las ciudades en la BB.DD. jmfweather.db
    ...
    Además existen en caché los ficheros con las imágenes de los iconos correspodiente a cada condición meteorológica
...
8. Gestión correcta de preferencias del usuario.
    ...
    Existen 3 preferencias para móviles y una más para tablets.
         ...
         - Frecuencia de actualización de las condiciones meteorlógicas de cada ciudad de la BB.DD.
         - Unidad de los grados: Celsius o Farhenheit.

9. Perfecto funcionamiento de la app.

    Salvo inesperados, la aplicación funciona currectamente.

Extras:

1. Aspecto estético de la aplicación.

    La aplicación contiene los siguientes asptectos estéticos:
...
2. Utilidad real de la aplicación.
    ...
    Mas allá del aspecto estético y de la información presentada la aplicación tiene una utilidad real.
